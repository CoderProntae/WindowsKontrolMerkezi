...
public record ThemeDef(string Id, string Name, Color Surface, Color Card, Color Border, Color BorderAlt, Color Accent, Color AccentDim, Color Text, Color TextDim, bool IsDark, string? BackgroundPath = null);
...
public static class ThemeService
{
    ...
    {
        new("dark", "Koyu (Varsayılan)", ColorFromHex("#0B0B0E"), ColorFromHex("#121216"), ColorFromHex("#1A1A1F"), ColorFromHex("#2A2A2E"), ColorFromHex("#8B5CF6"), ColorFromHex("#4C1D95"), ColorFromHex("#F4F4F5"), ColorFromHex("#A1A1AA"), true),
        new("light", "Açık", ColorFromHex("#FFFFFF"), ColorFromHex("#F3F4F6"), ColorFromHex("#E5E7EB"), ColorFromHex("#D1D5DB"), ColorFromHex("#7C3AED"), ColorFromHex("#A78BFA"), ColorFromHex("#111827"), ColorFromHex("#4B5563"), false),
        new("blue", "Mavi", ColorFromHex("#0C1222"), ColorFromHex("#111827"), ColorFromHex("#1F2937"), ColorFromHex("#1E3A5F"), ColorFromHex("#3B82F6"), ColorFromHex("#1D4ED8"), ColorFromHex("#E5E7EB"), ColorFromHex("#9CA3AF"), true),
        ...
        new("fish", "🐠 Balıklar (Özel)", ColorFromHex("#041B2D"), ColorFromHex("#062841"), ColorFromHex("#093A5E"), ColorFromHex("#0D4D7A"), ColorFromHex("#00D2FF"), ColorFromHex("#0095B6"), ColorFromHex("#E0F7FA"), ColorFromHex("#81D4FA"), true, Path.Combine(ArtifactDir, "fish_theme_background_1771796077793.png")),
        new("lava", "🌋 Lav (Özel)", ColorFromHex("#120000"), ColorFromHex("#1A0000"), ColorFromHex("#2A0000"), ColorFromHex("#3A0000"), ColorFromHex("#FF4500"), ColorFromHex("#B22222"), ColorFromHex("#FFF5F5"), ColorFromHex("#FFBABA"), true, Path.Combine(ArtifactDir, "lava_theme_background_1771796093605.png")),
