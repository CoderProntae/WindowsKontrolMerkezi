...
public record ThemeDef(string Id, string Name, Color Surface, Color Card, Color CardAlt, Color Border, Color Accent, Color AccentDim, Color Text, Color TextDim, bool IsDark);
