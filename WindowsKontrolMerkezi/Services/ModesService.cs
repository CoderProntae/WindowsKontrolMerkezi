...
public static class ModesService
{
    ...
    public static IReadOnlyList<ModeDefinition> BuiltInModes => new[]
    {
        ...
        new ModeDefinition { Id = "odak", Name = "Odak (çalışma)", IsBuiltIn = true, Order = 3, FocusAssistOn = true, GameModeOn = false, SpecialActionUri = "ms-settings:quiethours" },
    ...
    public static void ApplyMode(ModeDefinition mode)
    {
        ...
        if (mode.FocusAssistOn.HasValue)
